...
namespace Orien.NetUi {
    class McTabs : TabControl {
        ...
        protected override void OnDrawItem(DrawItemEventArgs e) {
            ...
            e.Graphics.DrawString(page.Text, this.Font, new SolidBrush(forecolor), paddedBounds);

            Point pad = this.Padding;
            //drawing close button to tab items
            e.Graphics.DrawString("X", new Font("Microsoft YaHei UI", 10, FontStyle.Bold),
            new SolidBrush(closebuttoncolor), e.Bounds.Right + 1 - 18, e.Bounds.Top + pad.Y - 2);
        ...
        /*protected override void OnMouseDown(MouseEventArgs e) {
            ...
            for ( int i = 0; i < this.TabPages.Count; i++ ) {
                ...
                if ( closeButton.Contains(e.Location) ) {
                    if ( MessageBox.Show("Do you want to Close this Tab ?", "Close or Not",
